...
export default class Localizacion extends Component {
 ...
 se
  ...
  usuariocap(){
      return `Hola ${this.state.usuario} por favor presiona MI UBICACIÓN`
  }
enviar(){
      ...
      <SafeAreaView style={styles.container}>
        <View style={styles.container}>
          <Button
            ...
            style={styles.boton}
          />
          <Text style={styles.blanco, styles.paragraph}>{this.usuariocap()}</Text>
          ...
          <Text style={styles.blanco, styles.paragraph}>{this.state.fecha}</Text>
          <Button
            title="ENVIAR DATOS"
            style={styles.boton}
            onPress={() => {this.enviar()}}
